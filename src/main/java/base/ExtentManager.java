...
public class ExtentManager {
    ...
    public static synchronized ExtentReports createInstance() {
        ...
        if (extent == null) {
            ...
            extent.setSystemInfo("Executed on Environment: ", TestUtil.getPropertyValueByKey("url"));
            extent.setSystemInfo("Executed on Browser: ", TestUtil.getPropertyValueByKey("browser"));
